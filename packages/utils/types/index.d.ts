...
declare module '@wk-libs/utils' {
	...
	export function getDomByClass(container: HTMLElement|Element, className: string): HTMLElement[]|Element[];
	export function getStyleByDom(dom: HTMLElement|Element, attr: string, isStyle?: boolean): string|number|null;
	export function setStyleByDom(dom: HTMLElement|Element, attr: string, value: string, isStyle ?: boolean): void;
	...
	export function isUseful(value: any): value is any[]|object|string|Function|number;
